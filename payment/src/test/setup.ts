...
process.env.STRIPE_KEY= "sk_test_51MEvTdFXe7sbZaR14h81x970hpqqQqs8VE5qRMZ4lZi0sT34PAIgwHnWsDYsz1hCSDIhNQRH5efGGVBmM81IPl6i00UNoyJQOR";

beforeAll(async() => {
    process.env.JWT_KEY = "ngasal";
    process.env.NODE_TLS_RECJECT_UNAUTHORIZE = "0";
